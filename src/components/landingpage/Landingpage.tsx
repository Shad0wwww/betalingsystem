            ...
            <div className="flex flex-col justify-center items-center">
                <div className='text-center max-w-5xl flex flex-col justify-center items-center z-10'>
                    ...
                    <p className="text-secondaryText font-medium mt-8 text-lg max-w-2xl text-gray-300">
                        Kammarslusen Ribe et betalingsystem for skibene i Ribe. Det er et system, der gør det nemt for skibene at betale for at komme igennem slusen, og det gør det også nemt for slusen at holde styr på, hvilke skibe der har betalt, og hvilke der ikke har.
                    </p>
                </div>
